        ...
        <div className='px-5 md:px-20 py-10'>
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
                ...
                <div className='relative'>
                    <h1 className='mb-5 lg:text-4xl font-bold grow'>{productData?.title}</h1>

                    <div className='my-2'>
                        <span className='text-lg font-semibold'>Price: </span>
                        <span className='text-2xl !text-primary'>{productData?.price} $</span>
                    </div>

                    <div className='my-2'>
                        <span className='text-lg font-semibold'>Category: </span>
                        <span className='!text-primary'>{productData?.category?.name}</span>
                    </div>
                    ...
                    <div className='mt-5 text-lg text-justify'>{productData?.description}</div>
                </div>
            </div>
            ...
            <div>
                ...
                <div className='grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 px-2 lg:px-[40px] gap-8 md:max-w-[900px] lg:max-w-[1200px] mx-auto'>
                    {relatedData.map((product: IProduct) =>
                        isFetchingRelated ? (
